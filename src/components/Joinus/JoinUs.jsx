        ...
        <div className="join-us-container">
          <div className="contents">
            ...
            <section id="benefitsnew" className="joinnew">
              ...
              <p>
                At UniScout, we are dedicated to fostering a work
            ...
            <section id="testimonialsnew">
              ...
              <p>
                ...
                employees have to say about working at UniScout:
              </p>
              <JoinStories />
            </section>
            ...
            <section id="applynew">
              ...
              <p>
                ...
                <a href="mailto:careers@UniScout.com">
                  careers@UniScout.com
                </a>
              ...
              <ol className="cultin">
                ...
                <li className="text">
                  Why you are interested in joining UniScout.
                </li>
