  ...
  <section className="section-stories">
    <div className="row">
      <Story
        ...
        text="Working at UniScout has been an incredible journey. The collaborative environment and the focus on innovation make every day exciting."
      />
      <Story
      ...
      <Story
        ...
        name="Alan Johnson"
        role="Data Analyst"
        text="Being part of the UniScout team has been a remarkable experience. The data-driven culture and supportive colleagues make it a great place to work."
      />
      <Story
        imgSrc="https://images.pexels.com/photos/2379005/pexels-photo-2379005.jpeg"
        name="Michael Brown"
        role="UX Designer"
        text="UniScout has given me the opportunity to work on innovative projects and collaborate with a talented team. It's a place where creativity thrives."
      />
      <Story
        imgSrc="https://images.pexels.com/photos/733872/pexels-photo-733872.jpeg"
        name="Emma Wilson"
        role="Marketing Specialist"
        text="At UniScout, I've been able to develop my skills and grow in my career. The company's commitment to employee development is truly outstanding."
      />
      <Story
        imgSrc="https://images.pexels.com/photos/91227/pexels-photo-91227.jpeg"
        name="David Lee"
        role="Product Manager"
        text="Working at UniScout has been a fulfilling experience. The supportive work environment and focus on innovation make it a great place to build a career."
      />
    </div>
  </section>
);
