        ...
        <div className="footer-bottom">
          ...
          <div className="footer-copyright">
            <p className="text">
              ...
              © {new Date().getFullYear()} from UniScout
            </p>
          </div>
          <ul className="social-icons">
            <li><a href="https://github.com/Shreyaspatil2310" target="_blank" rel="noreferrer"><FaGithub /></a></li>
            ...
            <li><a href="https://www.linkedin.com/in/shreyaspatil23/" target="_blank" rel="noreferrer"><FaLinkedin /></a></li>
