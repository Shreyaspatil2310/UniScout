...
const Help = () => {
  ...
  const faqs = [
    {
      question: "What is UniScout Social?",
      answer:
        "UniScout Social is a platform designed to connect individuals with professional counselors, offering a variety of other technical services also.",
    },
    {
